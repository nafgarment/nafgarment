...
router.post('/', asyncHandler(async (req, res) => {
    try {
        ...
        uploadProduct.fields([
            ...
            const { name, description, quantity, minQuantity, price, offerPrice, wholesalePrice, wholesaleOfferPrice, proCategoryId, proSubCategoryId, proBrandId, proVariantTypeId, proVariantId } = req.body;
            ...
            fields.forEach((field, index) => {
                if (req.files[field] && req.files[field].length > 0) {
                    ...
                    const imageUrl = `${process.env.BASE_URL_IMAGE}/products/${file.filename}`;
                    imageUrls.push({ image: index + 1, url: imageUrl });
                }
            });

            // Create a new product object with data
            const newProduct = new Product({ name, description, quantity, minQuantity, price, offerPrice, wholesalePrice, wholesaleOfferPrice, proCategoryId, proSubCategoryId, proBrandId,proVariantTypeId, proVariantId, images: imageUrls });
...
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        uploadProduct.fields([
            ...
            const { name, description, quantity, minQuantity, price, offerPrice, wholesalePrice, wholesaleOfferPrice, proCategoryId, proSubCategoryId, proBrandId,proVariantTypeId, proVariantId, images: imageUrls } = req.body;
            ...
            productToUpdate.wholesalePrice = offerPrice || productToUpdate.wholesalePrice;
